...
const config = {
    ...
    announceMessages: ['The Game is Euchre','Breaking Bad or the Wire','Dont go talk to random98 hes meg','Peter what are you doing','Daddy i want a turn on the swing set','Donkey Kong Secret Level','Hey Peter'],
